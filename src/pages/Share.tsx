...
import { ArrowLeft, Download, Facebook, Share as ShareIcon } from 'lucide-react';
  ...
  if (!imageUrl) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-cyan-100 flex items-center justify-center p-4">
        <Card className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Foto tidak ditemukan</h2>
          <p className="text-gray-600 mb-6">Silakan ambil foto terlebih dahulu</p>
          <Button onClick={() => navigate('/photobooth')} className="bg-gradient-to-r from-pink-500 to-purple-500">
            Ambil Foto
          </Button>
        </Card>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-cyan-100 p-4">
      <div className="max-w-md mx-auto">
        ...
        <Card className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden">
          {/* Preview */}
          <div className="p-6">
            <div className="aspect-[9/16] bg-gray-100 rounded-2xl overflow-hidden mb-6">
              <img 
                src={imageUrl} 
                alt="Edited Preview" 
